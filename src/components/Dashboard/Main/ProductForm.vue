...
<template>
	<div>
		<label class="font-medium text-gray-900">S.No</label>
		<input
			type="text"
	...
	<div class="grid grid-rows-4 grid-cols-2 md:grid-rows-2 md:grid-cols-3 gap-y-3 gap-x-4">
		...
		>
			...
			<input
				class="w-full px-4 py-2 mt-1 text-lg placeholder-gray-400 bg-gray-200 rounded focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50"
		...
		<div>
			...
			<input
				type="text"
				class="text-gray-400 w-full px-4 py-2 mt-1 text-lg placeholder-gray-400 bg-gray-200 rounded focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50"
				placeholder="Total"
