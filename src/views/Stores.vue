...
<template>
	<div class="mx-auto w-full">
		<div v-if="!stores" class="bg-white min-h-screen dark:bg-gray-800">
			<div
				class="lg:flex lg:items-center md:mt-20 lg:justify-between w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20"
			>
		...
		<div v-else="stores" class="container lg:mt-9 px-4 mx-auto sm:px-8">
			<div class="py-8">
