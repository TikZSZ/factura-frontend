		...
		<div class="container max-w-7xl mx-auto">
			...
			<div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 px-4 sm:px-8 xl:px-0">
				...
				>
					...
					>Each of our plan will provide you and your team with certifications.</p>
				</div>
				...
				>
					...
					<p
						class="text-base text-center text-gray-500"
					>Send out notifications to all your customers to keep them engaged.</p>
				</div>
				...
				>
					...
					<p
						class="text-base text-center text-gray-500"
					>High-quality bundles of awesome tools to help you out.</p>
				</div>
				...
				>
					...
					<p
						class="text-base text-center text-gray-500"
					>Developer tools to help grow your application and keep it up-to-date.</p>
				</div>
				...
				>
					...
					<p
						class="text-base text-center text-gray-500"
					>The right kind of building blocks to take your company to the next level.</p>
				</div>
				...
				>
					...
					<p
						class="text-base text-center text-gray-500"
					>Coupons system to provide special offers and discounts for your app.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="px-8 mx-auto max-w-7xl lg:px-16">
			...
			<div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
				...
				<div>
					...
					<p>
						You can start using factura today. Just <router-link to="/signup" class="text-indigo-500 underline">SignUp</router-link> and get started
					</p>
	...
	<section class="bg-gray-100">
		<div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
			<div class="flex justify-center  space-x-6">
				<a href="http://twitter.com/TikZ41414516" target="__blank" class="text-gray-400 hover:text-gray-500">
